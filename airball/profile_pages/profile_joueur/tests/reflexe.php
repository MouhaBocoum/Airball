    ...
    <div class="container">
        <div class="resultats_test">
            ...
            <script>
                ...
                var myChart = new Chart(ctx, {
                    type: 'line',
                    data: {
                        labels: [<?php echo $test_dates_reflexe?>],
                        datasets: [{
                            label: 'Résultats tests reflexe',
                            data: [<?php echo $resultats_reflexe?>],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
        ...
        <div class="down_panel">
            ...
            <div class="input_value">   
                ...
                <form action="reflexe.php" method="post">
                    ...
                    <button type="submit" name="valider_test_result_reflexe">Valider résultat</button>    
