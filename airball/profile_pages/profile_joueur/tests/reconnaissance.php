    ...
    <div class="container">
        <div class="resultats_test">
            ...
            <script>
                ...
                var myChart = new Chart(ctx, {
                    type: 'line',
                    data: {
                        labels: [<?php echo $test_dates_reconnaissance?>],
                        datasets: [{
                            label: 'Résultats tests reconnaissance sonore',
                            data: [<?php echo $resultats_reconnaissance?>],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
        ...
        <div class="down_panel">
            ...
            <div class="input_value">   
                ...
                <form action="reconnaissance.php" method="post">
                    ...
                    <button type="submit" name="valider_test_result_reconnaissance">Valider résultat</button>    
