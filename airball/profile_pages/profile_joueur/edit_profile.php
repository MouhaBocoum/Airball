...
<body>
    ...
    <div class="club">
        <form action="mon_club.php" method="post">
           ...
           <input type="text" placeholder="Nom" name="edit_nom" value="<?php echo $club_name?>">
           <input type="text" placeholder="Prénom" name="edit_prenom" value="<?php echo $club_email?>">
           ...
           <button type="submit" name="valider_edit">Valider profil</button> 
